...
const Login =()=>{
    ...
    const submit = () => {
        ...
        if(user.username===''&&user.password===''){
            setAlert({text:"Please enter a valid username and a password", variant:'warning'})
        }
    ...
    <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginTop:60}}>
        ...
        <Form onChange={onChange} style={{width: '40%', padding: 25,  border: '1px grey solid', borderRadius:30, boxShadow:'1px black'}}>
            ...
            <Button style={{float:'right'}} variant="primary" type="button" onClick={
                ()=>submit()}>
                Submit
            </Button>
        </Form>
